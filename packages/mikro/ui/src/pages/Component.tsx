...
export default function Component() {
	...
	const componentVersions = window.mikroData.components[params.name];
	...
	const importMaps = !window.mikroData.importMap
		? ""
		: `<script type="importmap">
${JSON.stringify(window.mikroData.importMap, null, 2)}
</script>
`;
